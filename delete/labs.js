...
function deleteLab(button) {
  ...
  let height = cells[3].innerText;
  let weight = cells[4].innerText;
  let diastolic = cells[5].innerText;
  let systolic = cells[6].innerText;
  ...
  $.ajax({
    ...
    success:function(data){
      if(data=="Success") {
        setTimeout(function() {
            swal({
                title: "General lab metrics deleted!",
                text: "The lab metrics were successfully deleted.",
                type: "success",
