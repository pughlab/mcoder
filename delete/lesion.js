// Delete a skin lesion
function deleteLesion(button) {
  ...
  $.ajax({
    ...
    success:function(data){
      if(data=="Success") {
        setTimeout(function() {
            swal({
                title: "Skin Lesion deleted!",
                text: "The skin lesion was successfully deleted",
                type: "success",
