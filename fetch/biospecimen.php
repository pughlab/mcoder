...
if(isset($_POST["query"]))
{
 ...
 $query = "
  SELECT HEX(Biospecimens.id), Biospecimens.date, Biospecimens.type, Biospecimens.cellularity, Biospecimens.collection, Biospecimens.storage, Biospecimens.bankingid, Biospecimens.paired, Biospecimens.imaging, Biospecimens.comment FROM Biospecimens, Patient
  WHERE Biospecimens.id = {$enc_search} AND Biospecimens.id = Patient.id AND INSTR('".$roles."', Patient.study) > 0
 ";
}
else
{
