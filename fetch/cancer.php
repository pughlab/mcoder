...
if(isset($_POST["query"]))
{
 ...
 $query = "
  SELECT HEX(Diseases.id), Diseases.date, Diseases.type, Diseases.histology, Diseases.status, Diseases.code, Diseases.side, Diseases.oncotree, Diseases.clinicalsg, Diseases.clinicalss, Diseases.pathologicsg, Diseases.pathologicss, Diseases.comments FROM Diseases, Patient
  WHERE Diseases.id = {$enc_search} AND Diseases.id = Patient.id AND INSTR('".$roles."', Patient.study) > 0
 ";
}
else
{
