...
if (isset($_POST["query"])) {
 ...
 $query = "
  SELECT * FROM ManifestationsNF1, Patient
  WHERE ManifestationsNF1.id LIKE '%ZZZZZZZZZZZZZZ%'
  AND ManifestationsNF1.id = Patient.id
...
$('#nf1manifdata tfoot th').each( function () {
    var title = $(this).text();
...
<div id="delete_nf1manif_<?php echo $rowNumber; ?>" class="modal fade" role="dialog">
 ...
 echo $output;
  ...
  <body>
  <?php
 echo '<span style="color:#349A0A;text-align:center;"><i class="glyphicon glyphicon-ok"></i><b> No manifestations have been registered yet for this patient.</b></span>';
}
