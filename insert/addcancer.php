<?php
	...
	$sql = "INSERT INTO `Diseases`(`id`, `date`, `type`, `histology`, `status`, `code`, `side`, `oncotree`, `clinicalsg`, `clinicalss`, `pathologicsg`, `pathologicss`, `comments`, `tracking` )
	VALUES ($enc_id,'$date','$type','$histology','$status','$location','$side','$oncotree','$clinicalsg','$clinicalss','$pathologicsg','$pathologicss','$comment', '$tracking')";
