...
$('#savecbc').click(function(e) {
  ...
  var date = document.getElementById("cbcdate").value;
  var type = $("#cbctype :selected").text();
  var count = document.getElementById("cbccount").value;
  var comment = document.getElementById("cbccom").value;
