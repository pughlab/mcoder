<?php
	...
	$sql = "INSERT INTO `DiagnosisNF1`(`id`, `date`, `diagnosis`, `mode`, `criteria`, `severity`, `visibility`, `age`, `circumference`, `comment`, `tracking`)
	VALUES ($enc_id,'$date','$diagnosis','$mode','$criteria','$severity','$visibility','$age','$head','$comment', '$tracking')";
