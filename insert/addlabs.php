<?php
	...
	$sql = "INSERT INTO `Lab`(`id`, `date`, `location`, `height`, `weight`, `diastolic`, `systolic`, `comment`, `tracking`)
	VALUES ($enc_id,'$date','$location','$height','$weight','$diastolic','$systolic','$comment', '$tracking')";
