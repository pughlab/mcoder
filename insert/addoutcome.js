...
$('#saveoutcome').click(function(e) {
  ...
  var date = document.getElementById("outcomedate").value;
  var status = $("input[name='cancerstatus']:checked").val();
  var comment = document.getElementById("cancerstatuscom").value;
