// Save a patient
$('#updateoutcome').click(function(_e) {
  ...
  let date = document.getElementById("outcomedate").value;
  let status = $("input[name='cancerstatus']:checked").val();
  let comment = document.getElementById("cancerstatuscom").value;
